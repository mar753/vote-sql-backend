...
/****** Object:  Database [vote]    Script Date: 23.08.2018 22:52:38 ******/
CREATE DATABASE [vote]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'vote', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\vote.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'vote_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\vote_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [vote] SET COMPATIBILITY_LEVEL = 140
GO
...
ALTER DATABASE [vote] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [vote] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [vote] SET QUERY_STORE = OFF
GO
